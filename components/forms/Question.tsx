            ...
            <FormItem className="flex w-full flex-col gap-3">
              ...
              <Editor
                ...
                init={{
                  ...
                  menubar: false,
                  plugins: [
                    'advlist', 'autolink', 'lists', 'codesample', 'link', 'image', 'charmap', 'preview',
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Add up to 3 tags to describe what your question is about. You need to press endter to add a tag.
              </FormDescription>
              <FormMessage className="text-red-500" />
            </FormItem>
          )}
